...
inline std::vector<std::string> il2cpp_native_func_name = {
...
inline std::map<std::string, std::vector<int>> il2cpp_native_func_property = {
    {"g_free", {1, TYPE_VOID}},
...
inline std::map<std::string, std::string> il2cpp_mono_native_func_map = {
    {"g_free", "g_free"},
